...
export default async function AnimePreviewList({
  type,
  query,
  title,
}: {
  ...
  return (
    <div className="w-full min-h-max p-2">
      ...
      <div className="w-full h-max overflow-scroll">
        ...
        ) : <div className="w-full h-32 md:h-64 rounded-2xl bg-gray-800/80 animate-pulse flex items-center justify-center">
              <p>Failed to get animation data.</p>
            </div>}
      </div>
    </div>
  );
