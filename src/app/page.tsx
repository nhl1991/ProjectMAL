    ...
    <main className="w-full h-full relative">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center ">
        ...
        <div className="rounded-2xl relative" >
          {backgroundImage && <Image src={backgroundImage} className="bg-center bg-no-repeat object-cover " sizes="(max-width: 768px) 70vw, 33vw" fill priority={true} alt="background-image" />}
